...
<head>
	...
	<meta name="description" content="Responsive Admin &amp Dashboard Template based on Bootstrap 5">
		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
			        ...
			        <li class="sidebar-header">Payment Setting</li>
		            <li class="sidebar-item  {{request()->routeIs('customer.payment')?'active': ''}}">
						<a class="sidebar-link" href="{{route('customer.payment')}}">
                            <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Payment</span>
                        </a>
					</li>

					
                    <li class="sidebar-header">Affiliate</li>
		            <li class="sidebar-item  {{request()->routeIs('customer.affiliate')?'active': ''}}">
						<a class="sidebar-link" href="{{route('customer.affiliate')}}">
                            <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Affiliate</span>
                        </a>
					</li>
		            ...
		            <li class="sidebar-item  {{request()->routeIs('order.history')?'active': ''}}">
						<a class="sidebar-link" href="{{route('customer.history')}}">
                            <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Order History</span>
                        </a>
					</li>
